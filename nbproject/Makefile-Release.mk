...
${OBJECTDIR}/Source/SingleVector.o: Source/SingleVector.cpp 
	${MKDIR} -p ${OBJECTDIR}/Source
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/SingleVector.o Source/SingleVector.cpp
...
${TESTDIR}/tests/DoubleVectTest.o: tests/DoubleVectTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DoubleVectTest.o tests/DoubleVectTest.cpp


${TESTDIR}/tests/RunDoubleTest.o: tests/RunDoubleTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RunDoubleTest.o tests/RunDoubleTest.cpp
...
${TESTDIR}/tests/RuntSingleVector.o: tests/RuntSingleVector.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RuntSingleVector.o tests/RuntSingleVector.cpp


${TESTDIR}/tests/testSingleVector.o: tests/testSingleVector.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testSingleVector.o tests/testSingleVector.cpp
...
${OBJECTDIR}/Source/SingleVector_nomain.o: ${OBJECTDIR}/Source/SingleVector.o Source/SingleVector.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Source/SingleVector_nomain.o Source/SingleVector.cpp;\
	else  \
